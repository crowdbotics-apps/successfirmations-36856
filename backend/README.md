...
## Project Structure
    ...
    ├── successfirmations_36856  # Django project configurations
...
1. Clone this repo and `cd successfirmations_36856`
...
2. Clone this repo and `cd successfirmations_36856`
